...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SSLCommerz",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC10SSLCommerz21AdditionalInformation")
...
SWIFT_CLASS("_TtC10SSLCommerz8CartItem")
...
SWIFT_CLASS("_TtC10SSLCommerz19CustomerInformation")
...
SWIFT_CLASS("_TtC10SSLCommerz14EMIInformation")
...
typedef SWIFT_ENUM(NSInteger, EMIOptions, closed) {
  EMIOptionsHasEMI = 1,
  EMIOptionsNoEMI = 0,
};


SWIFT_CLASS("_TtC10SSLCommerz22IntegrationInformation")
...
SWIFT_CLASS("_TtC10SSLCommerz18ProductInformation")
...
SWIFT_CLASS("_TtC10SSLCommerz14ProductProfile")
...
SWIFT_CLASS("_TtC10SSLCommerz10SSLCommerz")
...
SWIFT_PROTOCOL("_TtP10SSLCommerz18SSLCommerzDelegate_")
@protocol SSLCommerzDelegate
- (void)transactionCompletedWithTransactionData:(TransactionDetails * _Nullable)transactionData;
@end


SWIFT_CLASS("_TtC10SSLCommerz19ShipmentInformation")
...
SWIFT_CLASS("_TtC10SSLCommerz18TransactionDetails")
...
@interface UINavigationController (SWIFT_EXTENSION(SSLCommerz))
